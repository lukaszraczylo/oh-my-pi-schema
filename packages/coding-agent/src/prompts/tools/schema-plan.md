...
Requires a green backtest. Search is only complete relative to the model it runs over: over the wrong model, exhaustive search returns a confident wrong answer. That is why certification comes first.
