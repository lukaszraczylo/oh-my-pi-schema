...
const targets: BinaryTarget[] = [
	{
		...
		outfile: "packages/coding-agent/binaries/omps-darwin-arm64",
	},
	{
		id: "darwin-x64",
		platform: "darwin",
		...
		outfile: "packages/coding-agent/binaries/omps-darwin-x64",
	},
	{
		id: "linux-x64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/omps-linux-x64",
	},
	{
		id: "linux-arm64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/omps-linux-arm64",
	},
	{
		id: "linux-musl-x64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/omps-linux-musl-x64",
	},
	{
		id: "linux-musl-arm64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/omps-linux-musl-arm64",
	},
	{
		id: "win32-x64",
		platform: "win32",
		...
		outfile: "packages/coding-agent/binaries/omps-windows-x64.exe",
	},
	{
		id: "win32-arm64",
		platform: "win32",
		...
		outfile: "packages/coding-agent/binaries/omps-windows-arm64.exe",
	},
];
